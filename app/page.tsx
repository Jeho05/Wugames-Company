...
const beforeAfter = [
  {
    after: "Un seul interlocuteur pour tout le projet",
    before: "5 artisans différents, 5 interlocuteurs",
  },
  {
    after: "Suivi en temps réel de l&apos;avancement",
    before: "Plus de nouvelles pendant 3 semaines",
  },
  {
    after: "Devis clair, sans surprise",
    before: "Devis à 2M, facture finale à 5M",
  },
  {
    after: "Garantie décennale incluse",
    before: "Aucune garantie, bons sentiments",
  },
];
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-3 max-w-xs text-xs leading-5 text-slate-400">
                WUGAMS Holding Inc. &mdash; Bâtir, rénover, entreprendre. Avec la bonne équipe.
              </p>
            </div>
            <div>
