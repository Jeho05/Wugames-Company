...
import { blogCategories, blogPosts } from "@/app/lib/content-data";

export default function BlogPage() {
  const [category, setCategory] = useState("Tous");

  const visiblePosts = useMemo(
    () => (category === "Tous" ? blogPosts : blogPosts.filter((post) => post.category === category)),
    [category]
  );
      ...
      <section className="bg-[#101a2d] pb-12 pt-32 text-white">
        <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">
            Chantiers, matériaux, rénovation, entretien : les coulisses et les conseils de nos
            équipes, sans langue de bois.
          </p>
        </div>
      </section>
        ...
        {featured ? (
          ...
          >
            ...
            <div className="flex flex-col justify-center p-6 sm:p-8">
              ...
              <h2 className="mt-3 text-2xl font-bold tracking-[-0.04em] text-[#17294b] sm:text-3xl">
                {featured.title}
              </h2>
