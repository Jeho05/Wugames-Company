...
import { realisations } from "@/app/lib/content-data";
...
export default function RealisationsPage() {
  ...
  const visible = useMemo(
    () => (filiale === "Toutes" ? realisations : realisations.filter((r) => r.filiale === filiale)),
    [filiale]
  );
      ...
      <section className="bg-[#101a2d] pb-12 pt-32 text-white">
        <div className="mx-auto w-full max-w-[1240px] px-5 sm:px-8">
          ...
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">
            Chantiers livrés, lieux entretenus, meubles façonnés : la preuve par l&apos;ouvrage,
            filiale par filiale.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-[1240px] px-5 py-10 sm:px-8">
          ...
          {visible.map((realisation) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-slate-100">
                ...
                <span className="absolute right-3 top-3 rounded-full bg-white/90 px-2.5 py-1 text-[10px] font-bold text-[#17294b] backdrop-blur">
                  {realisation.value}
                </span>
              </div>
              <div className="p-5">
        ...
        <div className="mt-12 rounded-2xl bg-[#17294b] p-8 text-center text-white sm:p-12">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-300">
            Construction, rénovation, entretien ou mobilier : obtenez un devis clair et un
            calendrier engagé.
          </p>
          <Link
