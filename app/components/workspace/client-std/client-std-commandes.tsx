...
import type { ClientStdCommandeView } from "@/app/lib/client-std-data";
...
type ClientStdCommandesProps = {
  commandes: ClientStdCommandeView[];
};

export function ClientStdCommandes({ commandes }: ClientStdCommandesProps) {
  ...
  return (
    <ClientSection
      ...
      icon="shopping-bag"
      id="std-commandes"
      subtitle="Vos commandes passées auprès de WUGAMS"
      title="Mes commandes"
    >
...
function FragmentRow({
  ...
  commande: ClientStdCommandeView;
  index: number;
  isOpen: boolean;
  onToggle: () => void;
}) {
