        ...
        <div className="fixed inset-0 z-[60] flex items-start justify-center px-4 pt-[12vh]">
          ...
          >
            <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4 dark:border-white/5">
              ...
              <input
                aria-label="Rechercher dans vos missions, commandes et devis"
                autoComplete="off"
                ...
                placeholder="Rechercher une mission, commande, devis…"
                ref={inputRef}
                type="search"
                value={query}
              />
              ...
              {query.trim() === "" ? (
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-400">
                    Missions, commandes et devis — uniquement les vôtres.
                  </p>
                </div>
              ) : results.length === 0 ? (
                <div className="px-4 py-8 text-center">
