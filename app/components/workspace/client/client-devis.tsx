...
import type { ClientDevisView } from "@/app/lib/client-data";
...
type ClientDevisProps = {
  devis: ClientDevisView[];
};

export function ClientDevis({ devis }: ClientDevisProps) {
  ...
  return (
    <ClientSection
      ...
      icon="sparkles"
      id="portail-devis"
      subtitle="Vos demandes de devis, en toute transparence"
      title="Mes devis"
    >
                ...
                {isOpen ? (
                  ...
                  >
                    ...
                    <p className="mt-3 text-[11px] leading-5 text-slate-400">
                      Ce devis couvre la main-d&apos;œuvre, les matériaux et le nettoyage du chantier. Aucun frais caché.
                    </p>
                  </motion.div>
                ) : null}
              </AnimatePresence>
