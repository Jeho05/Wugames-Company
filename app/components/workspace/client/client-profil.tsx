...
const contactRows: { label: string; value: string; icon: IconName }[] = [
  { label: "Téléphone", value: "+225 07 08 45 12 36", icon: "phone" },
  { label: "Email", value: "contact@wugams.com", icon: "mail" },
  { label: "Adresse", value: "Résidence Les Palmiers, Cocody · Abidjan", icon: "map" },
...
export function ClientProfil({ user, fidelite }: ClientProfilProps) {
  ...
  return (
    <ClientSection icon="user" id="portail-profil" subtitle="Vos informations et la sécurité de votre compte" title="Mon profil">
        ...
        >
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#b47e1e]">Client membre WUGAMS</p>
              ...
              <div className="mt-2.5 flex flex-wrap items-center gap-2">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[#e3a641]/25 bg-[#e3a641]/[0.1] px-2.5 py-1 text-[11px] font-bold text-[#b47e1e]">
